...
import { MdOutlineFileUpload, MdOutlineFileDownload, MdEditCalendar, MdOutlineTableChart, MdSpaceDashboard } from 'react-icons/md';
        ...
        <>
            ...
            <div id='grid-container'>
                ...
                <div className='grid-item four'>
                    <NavLink to='/'><button className='btn'><MdSpaceDashboard style={{ color: '#2f3848', fontSize: '4rem' }} /><h5>Dashboard</h5></button></NavLink>
                </div>
